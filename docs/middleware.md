...
Trailer messages pass through unchanged, whether compression is enabled or skipped. When
compressing a response with trailers, the middleware finishes compression before forwarding
them. Native gRPC is excluded by default because its RPC implementation controls message compression.
